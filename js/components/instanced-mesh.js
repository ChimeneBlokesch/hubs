...
AFRAME.registerComponent('instanced-mesh', {
    ...
    constructMeshNodes: function (originalMesh) {
        ...
        console.log(originalMesh.type);

        // if (originalMesh.type == "Group") {
        //     for (let child of originalMesh.children) {
        //         meshNodes.push(cloneGLTF(child));
        //     }
