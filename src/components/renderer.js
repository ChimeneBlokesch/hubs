// Not the normal to import libraries, but this couldn't be installed using
// npm or CDN.
import "../node_modules/aframe-instanced-mesh/src/instanced-mesh";
    ...
    chooseType: function (el, init = false) {
        ...
        if (cam) {
            ...
            if (!this.frustum.containsPoint(el.object3D.position)) {
                // The object is not visible, don't render it.
